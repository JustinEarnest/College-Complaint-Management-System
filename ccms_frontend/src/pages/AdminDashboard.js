          ...
          <div className="modal-body">
            ...
            <div className="row mb-3">
              <div className="col-6">
                ...
                <div className={`p-2 border rounded ${complaint.priority === 'High' ? 'bg-danger-subtle text-danger' : 'bg-light'}`}>
                  {complaint.priority || 'Medium'}
                </div>
              </div>
              <div className="col-6">
                <strong>Category:</strong>
                <div className="p-2 bg-light border rounded">{complaint.category || 'Other'}</div>
              </div>
            </div>
            <div>
              <strong>Description:</strong>
              <div className="p-2 bg-light border rounded" style={{ whiteSpace: 'pre-wrap' }}>{complaint.description}</div>
            </div>
          </div>
